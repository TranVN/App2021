...
class PickerMapState extends State<PickerMap> {
  ...
  LatLng _latLng = LatLng(10.815308750460233, 106.7077935978961);
      ...
      setState(() {
        ...
        Future.delayed(Duration(seconds: 3), () {
          if (_currentPostion != null) {
            ...
            _updateMarker('ThoViet-MarkerId', _currentPostion.latitude,
                _currentPostion.longitude);
          } else {
            _updateMarker('ThoViet-MarkerId', _latLng.latitude, _latLng.longitude);
          }
        });
      });
    }
  ...
  void initState() {
    ...
    widget.bloc.locationController.stream.listen(
        ...
        _updateMarker('ThoViet-MarkerId', location.lat, location.lng,
    ...
    return Container(
      child: GoogleMap(
        ...
        onTap: (latlng) async {
          ...
          _updateMarker('ThoViet-MarkerId', latlng.latitude, latlng.longitude);
        },
